#!/usr/bin/env bash
mvn -Dtest=Scratch#VerifyLogos -DaHubServer=localhost -DaHubPort=4444 -Dbrowser=FIREFOXMAC -Dinput=http://jaemzware.com/ -DaNumber=2 -Dreport=jaemzware -Duserid=jaemzware.com -DaString="//a" -DwaitAfterPageLoadMilliSeconds=0 test
