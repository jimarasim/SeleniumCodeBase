#!/usr/bin/env bash
mvn -Dtest=Scratch#VerifyLogos -Dinput=http://jaemzware.com -Duserid="jaemzware.com" -DaString="//img" -Dbrowser=FIREFOX -DaNumber=0 -Dreport=jaemzware -DwaitAfterPageLoadMilliSeconds=0 -Dlogging -Dnogrid -DnoScroll test
