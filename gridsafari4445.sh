#!/usr/bin/env bash
mvn -Dtest=Scratch#VerifyLogos -DaHubServer=localhost -DaHubPort=4445 -Dbrowser=SAFARI -Dinput=https://disney.com/ -DaNumber=3 -Dreport=verifylogosdisney -Duserid=disney.com -DaString="//a[@id='nav-logo')]" -DwaitAfterPageLoadMilliSeconds=0 test
